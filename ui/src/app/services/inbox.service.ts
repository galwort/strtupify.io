...
Our leadership team at startupify.io wanted to add a clock feature to the application, so that has been added in the bottom right of the screen. If you are using a computer to access this inbox, which would be the only way to access this inbox, you should also see a clock somewhere on your screen. Leadership insisted that we needed a clock to compete with the computer companies. Let me know if you need a walkthrough of how a clock works. I am very good at programming, so you should not see any errors with anything, like the clock moving faster than it should. But if you experience an error, the standard operating protocol procedure is to send me an email. I am very busy and have a large backlog of features that leadership wants added, so I might not get to your email immediately...
